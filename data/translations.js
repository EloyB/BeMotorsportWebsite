...
export const enUS = {
  ...
  cookie: {
    description: "This website uses cookies to provide you with a better service. By continuing on this site, you agree to this use.",
    moreInfo: "More info"
  }
};
...
export const nl = {
  ...
  trackdaysPage: {
    ...
    description:
      "Een raceauto huren via BE\xa0motorsport is nog nooit zo makkelijk geweest! Kijk op de kaart waar je graag wil rijden, klik in onderstaande agenda wanneer je beschikbaar bent, vul je gegevens in en wij bezorgen je een vrijblijvende offerte! Aarzel niet om ons te contacteren als de dag of auto van je keuze reeds geblokkeerd is. We zoeken samen naar een oplossing!",
  ...
  rentingPage: {
    ...
    section1: {
      ...
      bullet3: "Verzekering",
      bullet4: "Open pitlane sessie (volgens organisatie)",
  ...
  cookie: {
    description: "Deze website maakt gebruik van cookies om je een betere service te kunnen verzekeren. Door verder te gaan op deze site, ga je akkoord met dit gebruik.",
    moreInfo: "Meer info"
  }
};
...
export const fr = {
  ...
  home: {
    planSection: {
      ...
      shareARide: {
        title: "Share a ride",
        hover: "hover	Découvrez notre “covoiturage” (&) formule réseau à un budget raisonable",
      },
      VIP: {
        title: "VIP",
        hover:
          "BE\xa0motorsport arrange tout pour vous de A\xa0to\xa0Z avec une expérience VIP",
      },
      business: {
        title: "Business",
  ...
  trackdaysPage: {
    ...
    selectTrackdaysPlaceholder: "Select a circuit on the map to view the available trackdays.",
    noTrackdaysFoundPlaceholder: "Sélectez un circuit sur la carte afin de voir les journées de piste disponibles.",
  },
  reservationPage: {
    title: "Planifiez votre journée de piste.",
    description: "Planifiez votre journée maintenant et nous vous enverrons un devis sans obligation.",
    trackdaysStep: {
  ...
  contactPage: {
    ...
    didierDescription:
      "didierDescription	N'hésitez pas à me contacter si vous avez des questions sur nos forfaits. Je serai heureux de vous aider!",
    stephanDescription:
    ...
    julieDescription:
      "julieDescription	Vous souhaitez organiser un événement créatif pour votre équipe? Ou souhaitez-vous organiser un team building avec des ateliers inspirants, mais vous ne savez pas comment vous y prendre? N'hésitez pas et appelez-moi! Je serai heureux de vous aider!",
    fullName: "Nom",
    message: "Message",
  ...
  rentingPage: {
    ...
    callToAction: "Organiser une journée de piste",
  ...
  cookie: {
    description: "Ce site utilise des cookies pour vous offrir un meilleur service. En poursuivant sur ce site, vous acceptez cette utilisation.",
