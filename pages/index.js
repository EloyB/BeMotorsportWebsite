    ...
    <div>
      <div className="h-screen w-full md:h-screen">
        ...
        <div className="m-auto py-10 px-8 space-y-5 grid grid-cols-1 sm:space-y-0 sm:grid-cols-2 sm:gap-5 lg:max-w-screen-lg lg:px-0 xl:max-w-screen-xl">
          <div className="cursor-pointer w-full h-52 bg-gray-200 flex items-center justify-center lg:h-64">
        ...
        <div className="bg-gray-50 py-10 px-8 ">
          <div className="md:px-0 md:flex md:flex-row-reverse md:items-center lg:max-w-screen-xl lg:m-auto">
            ...
            <div className="md:text-right inline-block md:px-5 lg:pr-16">
              ...
              <p className="text-xl font-light leading-3  md:text-lg lg:text-xl">
              ...
              <div className="mt-7 lg:mt-9">
                <Link href="/">
                  <a className="bg-motorblue rounded-md text-white font-medium px-8 py-3">
                    Meer over ons
                  </a>
                </Link>
              </div>
